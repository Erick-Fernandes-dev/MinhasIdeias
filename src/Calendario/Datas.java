...
public class Datas {
	...
	public static void main(String[] args) throws ParseException{
		...
		Date x3 = new Date(0l);
		Date x4 = new Date(1000l * 60l * 60l * 7l);
		
		Date y1 = sdf1.parse("07/09/2020");
		Date y2 = sdf2.parse("07/09/2020 15:29:00");
		Date y3 = Date.from(Instant.parse("2020-09-07T15:30:00Z"));
